...
Vyentei emojis, Zoitei, Korean
 ...
 - Zoitei Script (uses `U+200B` (ZWSP) zero width space for word separation,
   ...
   - …
   - `U+F62DC`: Zoitei Combined C(PFÞ) 'n-š' + 'm-þ,ŋ-ř'
   - …
   - `U+F6318`: Zoitei Combined R(PFÞ) 'ŋ-ł' + 'm-š,l-ř'
   - …
   - `U+F6354`: Zoitei Combined M(PFÞ) 'l-w' + 'm-ł,c-ř'
   - …
   - `U+F6390`: Zoitei Combined N(PFÞ) 'c-ž' + 'm-w,r-ř'
   - …
   - `U+F63CC`: Zoitei Combined Ŋ(PFÞ) 'r-ř' + 'm-ž'
   - …
   - `U+F6408`: Zoitei Combined P(LFÞ) + 'n-ř'
   - …
   - `U+F6444`: Zoitei Combined T(LFÞ) 'n-š' + 'm-þ,ŋ-ř'
   - …
   - `U+F6480`: Zoitei Combined K(LFÞ) 'ŋ-ł' + 'm-š,l-ř'
   - …
   - `U+F64BC`: Zoitei Combined B(LFÞ) 'l-w' + 'm-ł,c-ř'
   - …
   - `U+F64F8`: Zoitei Combined D(LFÞ) 'c-ž' + 'm-w,r-ř'
   - …
   - `U+F6534`: Zoitei Combined G(LFÞ) 'r-ř' + 'm-ž'
   - …
   - `U+F6570`: Zoitei Combined F(LPÞ) + 'n-ř'
   - …
   - `U+F65AC`: Zoitei Combined S(LPÞ) 'n-š' + 'm-þ,ŋ-ř'
   - …
   - `U+F65E8`: Zoitei Combined X(LPÞ) 'ŋ-ł' + 'm-š,l-ř'
   - …
   - `U+F6624`: Zoitei Combined V(LPÞ) 'l-w' + 'm-ł,c-ř'
   - …
   - `U+F6660`: Zoitei Combined Z(LPÞ) 'c-ž' + 'm-w,r-ř'
   - …
   - `U+F669C`: Zoitei Combined Ň(LPÞ) 'r-ř' + 'm-ž'
   - …
   - `U+F66D8`: Zoitei Combined Þ(LPF) + 'n-ř'
   - …
   - `U+F6714`: Zoitei Combined Š(LPF) 'n-š' + 'm-þ,ŋ-ř'
   - …
   - `U+F6750`: Zoitei Combined Ł(LPF) 'ŋ-ł' + 'm-š,l-ř'
   - …
   - `U+F678C`: Zoitei Combined W(LPF) 'l-w' + 'm-ł,c-ř'
   - …
   - `U+F67C8`: Zoitei Combined Ž(LPF) 'c-ž' + 'm-w,r-ř'
   - …
   - `U+F6804`: Zoitei Combined Ř(LPF) 'r-ř' + 'm-ž'
   - …
